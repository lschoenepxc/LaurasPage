...
namespace LaurasPage.DataAccess.Models
{
	public class ForecastModel
	{
        ...
        public string colourBz { get; set; }
        public string colourDensity { get; set; }
        public string colourSpeed { get; set; }
        public string colourKp1Hour { get; set; }
        public string colourKp4Hour { get; set; }
        public string colourKp { get; set; }
    }
}
